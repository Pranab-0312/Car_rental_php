...
?>
    ...
    <body background="assets/img/carr.png">
                 <!-- Navigation -->
        ...
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                            ...
                            <p class = "text-left"> Forgot Password ? <a href="recover_account.php">click here</a></p>
                            <p class = "text-left"> Not have an account ? <a href="customersignup.php">click here</a></p>
                        </form>
                    </div>
                </div>
            </div>
